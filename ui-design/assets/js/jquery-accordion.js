...
$(document).ready(function() {
	...
	$('.accordionButton').click(function() {
		...
		$('.accordionContent.paging').height($('.accordion-wrapper').height()-80);
		$('.accordionContent.features').height($('.accordion-wrapper').height()-40);
		
		// Temp fix, need to calc via JS
		$('.accordionContent.features-all').height($('.accordion-wrapper').height()-160);
